...
import java.net.*;		//for server and socket
 ...
 //class Server extends JFrame implements ActionListener{		//also works
	...
	Server(){
		...
		JPanel p1 = new JPanel();		//the profile panel
	...
	public static JPanel formatLabel(String out){		//to add timestamp below text
		JPanel panel = new JPanel();		//will consist of timestamp and the text sent
...
//here try-catch is used to maintain server availability and avoid abrupt termination of code in case of exceptions
